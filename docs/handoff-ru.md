...
!!! Репозиторий готов для реального интеграционного теста с DABOX, но ещё не является законченным промышленным контуром доставки.!!!
...
## 14. Что нужно получить от теста DABOX
